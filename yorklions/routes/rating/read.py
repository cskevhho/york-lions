...
def admin_get_ratings(request):
    ...
    rating_list = [{'_id': rating.id, 'year': rating.year, 'make': rating.make, 'model': rating.model, 'first name': rating.f_name, 'last initial': rating.l_initial, 'rating': rating.rating } for rating in ratings]
